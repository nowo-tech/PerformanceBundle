...
final class PerformanceControllerExportRecordsTest extends TestCase
{
    ...
    public function testExportRecordsCsvReturnsStreamedResponseWithRecords(): void
    {
        ...
        $controller->method('getParameter')->willReturnCallback(static fn (string $k): ?string => $k === 'kernel.environment' ? 'dev' : null);
        ...
        $this->recordRepository
            ...
            ->with('dev', null, null, null, null, null, null, null, null, null, null, null)
    ...
    public function testExportRecordsJsonReturnsJsonWithRecords(): void
    {
        ...
        $this->recordRepository
            ->expects(self::once())
            ->method('getRecordsForExport')
            ->with('prod', null, null, null, null, null, null, null, null, null, null, null)
            ->willReturn(['records' => [$record], 'total' => 1]);
    ...
    public function testExportRecordsJsonPassesFiltersFromRequest(): void
    {
        ...
        $this->recordRepository
            ...
            ->with(
                'test',
                self::callback(static fn ($v): bool => $v instanceof DateTimeImmutable && $v->format('Y-m-d') === '2026-01-01'),
                self::callback(static fn ($v): bool => $v instanceof DateTimeImmutable && $v->format('Y-m-d') === '2026-01-31'),
                'app_user',
                null,
                404,
                null,
