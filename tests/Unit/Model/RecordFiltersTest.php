...
final class RecordFiltersTest extends TestCase
{
    ...
    public function testConstructorWithValues(): void
    {
        ...
        $f     = new RecordFilters($start, $end, 'prod', 'app_user', null, 404);
    ...
    {
        $f = new RecordFilters(null, null, 'dev', '');
    ...
    {
        $f = new RecordFilters(null, null, null, null, null, 500);
    ...
    {
        $f = new RecordFilters(null, null, null, null, null, null, 0.0, 0.0);
    ...
    {
        $f = new RecordFilters(null, null, null, null, null, null, null, null, 0, 0);
    ...
    {
        $f = new RecordFilters(null, null, null, null, null, 0);
