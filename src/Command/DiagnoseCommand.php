...
HELP
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $environmentsRaw  = $this->parameterBag->get('nowo_performance.environments');
        $environments     = is_array($environmentsRaw) ? $environmentsRaw : [];
        ...
        if ($this->tableStatusChecker instanceof TableStatusChecker && $checkTableStatus) {
        ...
        } elseif ($this->tableStatusChecker instanceof TableStatusChecker && !$checkTableStatus) {
            $io->section('Database Tables');
